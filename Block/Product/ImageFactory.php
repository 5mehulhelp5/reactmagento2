...
namespace React\React\Block\Product;

use Magento\Catalog\Block\Product\Image as ImageBlock;
use Magento\Catalog\Block\Product\ImageFactory as Legacy;
 ...
 * @api
 */
class ImageFactory extends Legacy
{

    const TEMPLATE = 'React_React::product/image_with_borders.phtml';
